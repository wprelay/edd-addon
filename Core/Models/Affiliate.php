...
class Affiliate extends Model
{
    ...
    public static function createCoupon($affiliate, $program)
    {
        ...
        print_r($couponId);
        exit;
        $data = AffiliateCoupon::getCouponData($couponId);
    ...
    public static function getEddDiscountData($affiliate, $program, $customerDiscount)
    {
        return [
            ...
            'amount_type'       => $customerDiscount->discount_type, // Discount type (percent or flat)
            ...
            'once_per_customer' => $customerDiscount->individual_use ? 1 : 0, // Restrict to one use per customer
