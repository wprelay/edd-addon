                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                    <div style="font-family:Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                        <?php echo esc_attr__('Dear', 'relay-affiliate-marketing') ?>
                                                        {{affiliate_name}},
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div style="font-family:Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                        <?php
                                                        echo esc_html__("While we value your efforts and contributions as an affiliate, we must adhere to the guidelines and policies established to maintain the integrity of our affiliate program", 'relay-affiliate-marketing')
                                                        ?>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left"
                                                    style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                    <div style="font-family:Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                        <?php echo esc_attr__("Best regards", 'relay-affiliate-marketing') ?>
                                                        ,<br/>{{store_name}}<br/>
                                                    </div>
                                                </td>
                                            </tr>
